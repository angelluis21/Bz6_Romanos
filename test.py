...
class RomanosTest(unittest.TestCase):
    ...
    def test_MMMM(self):
        self.assertRaises(Overflow, romano_a_entero, 'MMMM')
    ...
    def test_VV(self):
        self.assertEqual(Overflow, romano_a_entero, 'VV')

    def test_repes(self):
        self.assertEqual(romano_a_entero('MMLXXIII'), 2037)

    def test_IV(self):
        self.assertEqual(romano_a_entero('IV'), 4)

    def test_Ic(self):
        self.assertRaises(romano_a_entero('IC')
